  ...
  if (success) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">Бүртгэл амжилттай!</h3>
        <p className="text-gray-500 mb-6">
          Таны и-мэйл хаяг руу баталгаажуулах линк илгээлээ. И-мэйлээ шалгана уу.
        </p>
        <Link
          to="/login"
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm"><span className="px-3 bg-white text-gray-400">эсвэл</span></div>
      </div>
      ...
      >
        ...
        {googleLoading ? 'Холбогдож байна...' : 'Google-ээр бүртгүүлэх'}
      </button>

      {/* Terms */}
      <p className="text-xs text-gray-400 text-center leading-relaxed">
        Бүртгүүлснээр та манай{' '}
        <a href="/terms" className="text-primary-600 hover:underline">Үйлчилгээний нөхцөл</a> болон{' '}
        <a href="/privacy" className="text-primary-600 hover:underline">Нууцлалын бодлого</a>-г зөвшөөрч байна.
      </p>
...
function getPasswordStrength(password: string) {
  ...
  if (score <= 1) return { level: 1, label: 'Сул', color: 'bg-red-500', textColor: 'text-red-500' };
  if (score <= 2) return { level: 2, label: 'Дунд', color: 'bg-yellow-500', textColor: 'text-yellow-600' };
  if (score <= 3) return { level: 3, label: 'Сайн', color: 'bg-blue-500', textColor: 'text-blue-600' };
  return { level: 4, label: 'Маш сайн', color: 'bg-primary-500', textColor: 'text-primary-600' };
}
