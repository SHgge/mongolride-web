-- ============================================================
-- EP-04 P1-5 fix: rsvp_event-ийн RETURNS TABLE дотор `status` нэр нь
-- event_rsvps.status / events.status багануудтай ambiguous болж буй.
-- OUT параметрийг `rsvp_status` болгож rename хийнэ. Frontend нь
-- зөвхөн error-ыг шалгадаг тул API contract өөрчлөгдөхгүй.
-- ============================================================
